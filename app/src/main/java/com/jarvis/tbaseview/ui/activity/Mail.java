...
public class Mail extends javax.mail.Authenticator {
    ...
    private String _user;//邮箱地址
    private String _pass;//开通smtp的时候的验证码而不是登录密码

    private String[] _to;//收件人邮箱地址
    private String _from;//发件人邮箱地址
    ...
    public boolean send() throws Exception {
        ...
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {
            ...
            我在这里犯了两个错误，
            一是mail.password写的是邮箱登录密码，应该写为开通pop3/smtp服务时的验证码；
            二是没有开通pop3/smtp服务
             */
            Transport.send(msg);
            return true;
