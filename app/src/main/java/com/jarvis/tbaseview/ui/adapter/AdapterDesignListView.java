...
public class AdapterDesignListView extends BaseAdapter {

	private Context context;
	private String[] strs;

	public AdapterDesignListView(Context context) {
		this.context=context;
		strs=context.getResources().getStringArray(R.array.design_title_strs);
	}
